			...
			<div class="succWrap"><strong>SUCCESS</strong></div>
  	         <div class="tab-content">
						...
						if(isset($_POST["submit"])) {
							...
							$file=$_file=$_FILES['image']['name'];
							$temp_file=$_FILES['image']['tamp_name'];
							$main_image='images/'.$file;

							move_uploded_file($temp_file, $main_image);
							...
							if(empty($clubname) || empty($clubtitle)) {
								...
								$insert_club=$db->insert($insert_quary);
								if($insert_club) {
									echo "<script>alert('insert sucsess')</script>";
								}else {
                        ...
                        <!-- Club Insert php End Here -->

							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Club Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="club_name"                                        placeholder="Create club" required>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Club Title </label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="image"                                        placeholder="Create club" required>
									</div>
								</div>
